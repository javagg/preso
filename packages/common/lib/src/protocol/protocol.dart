...
import 'node.dart' as _i9;
import 'order.dart' as _i10;
import 'permission.dart' as _i11;
import 'role.dart' as _i12;
import 'store.dart' as _i13;
...
import 'package:preso_common/src/protocol/store.dart' as _i18;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i13.Store) {
      return _i13.Store.fromJson(data) as T;
    }
    if (t == _i14.Tenant) {
    ...
    if (t == _i1.getType<_i13.Store?>()) {
      return (data != null ? _i13.Store.fromJson(data) : null) as T;
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'Store') {
      return deserialize<_i13.Store>(data['data']);
    }
