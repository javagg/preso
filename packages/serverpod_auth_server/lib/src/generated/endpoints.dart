...
import '../endpoints/wechat_endpoint.dart' as _i9;
...
// ignore: deprecated_member_use_from_same_package
    ...
    connectors['wechat'] = _i1.EndpointConnector(
      name: 'wechat',
      endpoint: endpoints['wechat']!,
      methodConnectors: {
        'authenticateWithServerAuthCode': _i1.MethodConnector(
          name: 'authenticateWithServerAuthCode',
          params: {
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['wechat'] as _i9.WechatEndpoint)
                  .authenticateWithServerAuthCode(
            session,
            params['authenticationCode'],
            params['redirectUri'],
