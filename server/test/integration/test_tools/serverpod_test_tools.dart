...
import 'package:preso_server/src/generated/note.dart' as _i4;
...
import 'package:preso_server/src/generated/endpoints.dart';
...
class TestEndpoints {
  ...
  late final _TenantEndpoint tenant;
...
class _StoreEndpoint {
  ...
  _i3.Future<List<_i5.Store>> all(_i1.TestSessionBuilder sessionBuilder) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
        endpoint: 'store',
...
class _TenantEndpoint {
  ...
  _i3.Future<List<_i6.Tenant>> all(
    _i1.TestSessionBuilder sessionBuilder,
    int? limit,
    int? offset,
  ) async {
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          ...
          endpointPath: 'tenant',
          methodName: 'update',
          parameters: _i1.testObjectToJson({'tenant': tenant}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue = await (_localCallContext.method.call(
          _localUniqueSession,
...
class _UserEndpoint {
  ...
  _i3.Future<bool> userInfoUpdate(
    _i1.TestSessionBuilder sessionBuilder,
    _i7.User user,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
  ...
  _i3.Future<List<_i7.User>?> getAll(
    _i1.TestSessionBuilder sessionBuilder, {
    int? limit,
    int? offset,
  }) async {
  ...
  _i3.Future<_i7.User?> getByUserInfoId(
    _i1.TestSessionBuilder sessionBuilder,
    int id,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
        endpoint: 'user',
        method: 'getByUserInfoId',
      );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'user',
          methodName: 'getByUserInfoId',
          parameters: _i1.testObjectToJson({'id': id}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue = await (_localCallContext.method.call(
